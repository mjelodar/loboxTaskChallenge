...
public interface BasicMovieJpaRepository extends JpaRepository<BasicMovie, String> {
    ...
    @Query(value = "select new com.lobox.demo.view.BasicMoviePlusRating(b.tconst, b.primaryTitle, b.startYear, b.genre, r.averageRating, r.numVotes) from BasicMovie b inner join Rating r ON b.tconst = r.tconst where b.genre=?1")
